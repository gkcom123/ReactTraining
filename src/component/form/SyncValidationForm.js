...
const SyncValidationForm = (props) => {
    ...
    return(
        <form onSubmit={handleSubmit}>
            <Field autoComplete="off" name="firstName" label="firstName" component={renderField} type="text" placeholder="First Name" autoComplete="off"/>
            <Field  autoComplete="off" name="email" component={renderField} type="email" placeholder="Email" autoComplete="off"/>
